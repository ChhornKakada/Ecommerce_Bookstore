  ...
  <div class="bg-[#1B1E2B] py-10">
    <footer class="w-[80%] mx-auto text-[#F1F5F8]">
      ...
      <div class="flex justify-center gap-5 my-10 ">
        <button>
          <svg class="Svg" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
            viewBox="0 0 16 16">
            <path
        ...
        <div class="flex w-full lg:w-3/4 gap-6 md:gap-12">
          <div class="content w-1/3 ">
            <h1 class="md:text-[1.2rem] font-medium mb-2">
              HELP CENTER</h1>
            <ul class="">
              <li><a href="#" class="Link">How to Pay</a></li>
              <li><a href="#" class="Link">FAQ's</a></li>
              <li><a href="#" class="Link">Sitemap</a></li>
              <li><a href="#" class="Link">Delivery Info</a></li>
            </ul>
          </div>
          <div class="content w-1/3  ">
            <h1 class="md:text-[1.2rem] font-medium mb-2">CUSTOMER INFORMATION</h1>
            <ul>
              <li><a href="#" class="Link">About Us</a></li>
              <li><a href="#" class="Link">Our Selling</a></li>
              <li><a href="#" class="Link">Contact Us</a></li>
            </ul>
          </div>
          <div class="content w-1/3 ">
            <h1 class="md:text-[1.2rem] font-medium mb-2">SECURITY & PRIVACY</h1>
            <ul>
              <li><a href="#" class="Link">Term of Use</a></li>
              <li><a href="#" class="Link">Privacy Policy</a></li>
              <li><a href="#" class="Link">Return / Refund Policy</a></li>
              <li><a href="#" class="Link">Store Location</a></li>
            </ul>
          </div>
        </div>

        <div class="content w-full lg:w-1/4  mt-8 lg:mt-0">
          <h1 class="md:text-[1.2rem] font-medium mb-2">PAYMENT</h1>
          <p>The payment aims to establish a relationship of trust between two parties carrying out a financial
            transaction
